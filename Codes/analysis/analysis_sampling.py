	    ...
	    for beta, T_total in zip(betas, Ts_total):
	        ...
	        #ax2.hlines([0, .9, 1],0,T_total, linestyle = 'dashed', color = 'silver', linewidth = 3)
	       	for m, color, color_m in zip(sample_sizes, colors, colors_m):
	       		...
	       		data_sampling_uniform_times = np.concatenate((data_sampling_uniform[:,0],data_sampling_uniform2[:,0]))
	       		data_sampling_uniform_cs = data_sampling_uniform2[:,5]
	       		...
	       		data_sampling_aposteriori_times = np.concatenate((data_sampling_aposteriori[:,0],data_sampling_aposteriori2[:,0]))
	       		data_sampling_aposteriori_cs = data_sampling_aposteriori2[:,5]
